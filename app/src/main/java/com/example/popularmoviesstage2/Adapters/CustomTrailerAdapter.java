...
public class CustomTrailerAdapter extends RecyclerView.Adapter<CustomTrailerAdapter.TrailerViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TrailerViewHolder holder, int position){
        ...
        if (trailer.getSite().equalsIgnoreCase("youtube")){
            ...
            builder.build().load(uri).placeholder((R.drawable.gradient_background))
    ...
    @Override
    public int getItemCount() { return trailers != null ? trailers.size() : 0;}

    //ViewHolder for review item view to reduce findViewById calls
    class TrailerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public boolean onLongClick(View v){
            ...
            if (video != null){
                ...
                Uri uri = Uri.parse("https://youtube.com/watch?v=" + video.getKey());
