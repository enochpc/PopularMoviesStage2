...
//class that takes the JSON data structure and makes a Parcel or parcelable of it
//each parcel as an object that can be queried for each specific data point
//the parcels are stored in a room database
...
public class Movie implements Parcelable {
    ...
    //helper functions to access the individual data points and set individual data points
